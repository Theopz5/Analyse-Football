...
@st.cache_data
def load_data():
    return pd.read_excel("/Users/Utilisateur/OneDrive - URCA/Bureau/Analyse Football/ressources/2022-2023 Football Player Stats.xlsx")
...
if poste == "Défenseur latéral":
    colonnes = ["Tkl", "TklWon", "TklDri", "Crs", "PasTotCmp%", "PasTotAtt", "Assists", "AerWon%"]
    ...
    colonnes = ["PasTotCmp%", "Assists", "Crs", "Tkl", "Int","Blocks", "Clr","TklWon"]
    ...
    colonnes = ["PasTotCmp%", "Assists", "Crs", "Tkl", "Int", "GcaSh", "SCA", "GCA"]
    ...
    colonnes = ["Goals", "Shots", "SoT%", "Assists", "G/Sh", "GcaSh","Crs", "ScaFld", "SCA", "CPA"]
...
#   streamlit run "C:/Users/Utilisateur/OneDrive - URCA/Bureau/Analyse Football/FOOT/Comparaison20222023.py"
